...
void cblas_gemm(const CBLAS_TRANSPOSE TransA,
              const CBLAS_TRANSPOSE TransB, const int M, const int N, const int K,
              const scalar_t alpha, const scalar_t* A, const scalar_t* B, const scalar_t beta,
              scalar_t* C);

template <typename scalar_t>
void cblas_gemv(const CBLAS_TRANSPOSE TransA, const int M, const int N,
              const scalar_t alpha, const scalar_t* A, const scalar_t* x, const scalar_t beta,
              scalar_t* y);
...
template <typename scalar_t>
scalar_t cblas_max(const int N, const scalar_t *X);
...
template<typename scalar_t>
void  cblas_add_scalar(const int N, const scalar_t *X, const scalar_t alpha,  scalar_t *Y);
